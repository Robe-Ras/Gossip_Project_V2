...
ActiveRecord::Schema[7.1].define(version: 2024_02_12_181642) do
  ...
  create_table "like_gossips", force: :cascade do |t|
    t.integer "user_id"
    t.integer "gossip_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["gossip_id"], name: "index_like_gossips_on_gossip_id"
    t.index ["user_id"], name: "index_like_gossips_on_user_id"
  end
